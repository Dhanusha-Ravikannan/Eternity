import {
  ...
  import {z} from "zod"
//   import { checkAvailabilityStock,} from "../jobcardvalidation/JobcardValidation";
          ...
          <div className={styles.newExpenseForm}>
            ...
            <div>
              <div className={styles.touchGroup}>
                ...
                <table className={styles.jobCardTouchTable}>
                  <thead>
                    <tr className={styles.jobCardTouchTableRow}>
                      <th>S.No</th>
                      <th>Touch</th>
                      <th>Weight</th>
                      <th>RemainWeight</th>
                  ...
                  <tbody>
                    {rawGold.map((rawStock, index) => (
                      <tr key={index + 1} className={styles.jobCardTouchTableBody}>
                        <td>{index + 1}</td>
